...
def replace_home_dir(cwd):
    home = os.getenv('HOME')
    home2 = "C:/Users/ben"
    root = "C:/Users/ben/AppData/Local/GitHub/PortableGit_d7effa1a4a322478cd29c826b52a0c118ad3db11"
    ...
    if cwd.startswith(home2):
        return '~' + cwd[len(home2):]
    return cwd
...
def requires_special_home_display(name):
    ...
    return (name == '~' or name == '/' and Color.HOME_SPECIAL_DISPLAY)
